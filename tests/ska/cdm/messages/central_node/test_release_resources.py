...
from ska.cdm.messages.central_node.release_resources import DishAllocation, ReleaseResourcesRequest
...
def test_release_resources_request_eq():
    ...
    request = ReleaseResourcesRequest(1, dish_allocation=dish_allocation, release_all=False)
    ...
    assert request != ReleaseResourcesRequest(1, dish_allocation=dish_allocation, release_all=True)
