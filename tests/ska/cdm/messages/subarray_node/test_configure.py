...
def test_configure_request_eq():
    ...
    request_1 = ConfigureRequest(pointing_config, dish_config, sdp_config, csp_config)
    ...
    fsp_config = FSPConfiguration(1, FSPFunctionMode.CORR, 1, 140, 0, channel_avg_map)
    csp_config = CSPConfiguration(csp_id, ReceiverBand.BAND_1, [fsp_config])
    request_2 = ConfigureRequest(pointing_config, dish_config, sdp_config, csp_config)
...
def test_configure_request_is_not_equal_to_other_objects():
    ...
    fsp_config = FSPConfiguration(1, FSPFunctionMode.CORR, 1, 140, 0, channel_avg_map)
    csp_config = CSPConfiguration(csp_id, ReceiverBand.BAND_1, [fsp_config])
    request = ConfigureRequest(pointing_config, dish_config, sdp_config, csp_config)
