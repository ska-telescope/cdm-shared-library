...
def test_target_defaults():
    ...
    target_2 = Target(ra=1, dec=0.5, name="", reference_frame="icrs", unit=("hourangle", "deg"))
...
def test_target_eq():
    ...
    """
    target_1 = Target(ra=1, dec=2, name="a source", reference_frame="fk5", unit="deg")
    target_2 = Target(ra=1, dec=2, name="a source", reference_frame="fk5", unit="deg")
...
def test_target_is_not_equal_to_other_objects():
    ...
    """
    target = Target(ra=1, dec=2, name="a source", reference_frame="fk5", unit="deg")
...
def test_target_repr():
    ...
    """
    target = Target(ra=30, dec=-3600, name="name", reference_frame="icrs", unit=("deg", "arcsec"))
    expected = (
...
def test_target_str():
    ...
    """
    target = Target(ra=30, dec="0", name="name", reference_frame="icrs", unit=("deg", "rad"))
...
def test_pointing_configuration_eq():
    ...
    target_1 = Target(ra=1, dec=2, name="a source", reference_frame="fk5", unit="deg")
    target_2 = Target(ra=1, dec=2, name="a source", reference_frame="fk5", unit="deg")
    target_3 = Target(ra=1, dec=2, name="foobar", reference_frame="fk4", unit="deg")
