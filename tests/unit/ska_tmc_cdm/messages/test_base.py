...
FIELD_CASES = (
    ...
    # Exclude=False, so MUST be included, even with empty defaults:
    pytest.param(object_factory(dict[str, str], default_factory=dict, value=..., exclude=False),  True, id="dict|default:{}|value:...|exclude=False"),
    pytest.param(object_factory(Optional[str],  static_default=None,  value=..., exclude=False),  True, id="Optonal[str]|default:None|value:...|exclude=False"),
)
# fmt: on
